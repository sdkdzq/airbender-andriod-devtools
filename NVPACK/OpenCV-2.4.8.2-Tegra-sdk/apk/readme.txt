...
.. code-block:: sh
    ...
    adb install OpenCV-2.4.8.2-android-sdk/apk/OpenCV_2.4.8.2_Manager_2.17_<platform>.apk
...
+==============================+==============+====================================================+
| Tegra 3/4/5                  |    >= 2.3    | OpenCV_2.4.8.2_Manager_2.17_armv7a-neon.apk          |
+------------------------------+--------------+----------------------------------------------------+
| Tegra 4i                     |    >= 2.2    | OpenCV_2.4.8.2_Manager_2.17_armeabi.apk              |
+------------------------------+--------------+----------------------------------------------------+
| Tegra 2                      |    >= 2.2    | OpenCV_2.4.8.2_Manager_2.17_armeabi.apk              |
|                              |              | OpenCV_2.4.8.2_binary_pack_armv7a.apk                |
+------------------------------+--------------+----------------------------------------------------+
| armeabi-v7a (ARMv7-A + NEON) |    >= 2.3    | OpenCV_2.4.8.2_Manager_2.17_armv7a-neon.apk          |
+------------------------------+--------------+----------------------------------------------------+
| armeabi-v7a (ARMv7-A + NEON) |     = 2.2    | OpenCV_2.4.8.2_Manager_2.17_armv7a-neon-android8.apk |
+------------------------------+--------------+----------------------------------------------------+
| armeabi (ARMv5, ARMv6)       |    >= 2.3    | OpenCV_2.4.8.2_Manager_2.17_armeabi.apk              |
+------------------------------+--------------+----------------------------------------------------+
| Intel x86                    |    >= 2.3    | OpenCV_2.4.8.2_Manager_2.17_x86.apk                  |
+------------------------------+--------------+----------------------------------------------------+
| MIPS                         |    >= 2.3    | OpenCV_2.4.8.2_Manager_2.17_mips.apk                 |
+------------------------------+--------------+----------------------------------------------------+
