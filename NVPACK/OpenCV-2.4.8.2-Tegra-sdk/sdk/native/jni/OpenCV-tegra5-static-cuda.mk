...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
	OPENCV_TARGET_ARCH_ABI=tegra5-static-cuda
else
...
OPENCV_MODULES:=contrib ocl stitching ts videostab photo objdetect legacy video ml calib3d features2d highgui imgproc flann androidcamera core
...
CUDA_RUNTIME_LIBS:=cufft nppc nppi npps cudart
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    ...
    ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
        ...
        OPENCV_EXTRA_COMPONENTS:=EGL GLESv2 c log m dl z
    endif
