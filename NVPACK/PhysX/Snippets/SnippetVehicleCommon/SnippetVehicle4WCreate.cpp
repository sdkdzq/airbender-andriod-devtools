...
void computeWheelCenterOffsets4W(const PxF32 wheelFrontZ, const PxF32 wheelRearZ, const PxVec3& chassisDims, const PxF32 wheelWidth, const PxF32 wheelRadius, const PxU32 numWheels, PxVec3* wheelCentreOffsets)
{
...
PxVehicleDrive4W* createVehicle4W(const VehicleDesc& vehicle4WDesc, PxPhysics* physics, PxCooking* cooking)
{
	...
	PxVehicleWheelsSimData* wheelsSimData = PxVehicleWheelsSimData::allocate(numWheels);
	{
		...
		computeWheelCenterOffsets4W(frontZ, rearZ, chassisDims, wheelWidth, wheelRadius, numWheels, wheelCentreOffsets);
		...
		PxVehicleSuspensionData suspensions[PX_MAX_NB_WHEELS];
		{
			...
			PxVehicleComputeSprungMasses(numWheels, wheelCentreOffsets, vehicle4WDesc.chassisCMOffset, vehicle4WDesc.chassisMass, 1, suspSprungMasses);
