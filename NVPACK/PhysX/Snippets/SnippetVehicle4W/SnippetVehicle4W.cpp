...
void initPhysics(bool interactive)
{
	...
	gVehicleSceneQueryData = VehicleSceneQueryData::allocate(PX_MAX_NB_WHEELS, gAllocator);
	gBatchQuery = gVehicleSceneQueryData->setUpBatchedSceneQuery(gScene);
...
void stepPhysics(bool interactive)
{
	...
	PxVehicleSuspensionRaycasts(gBatchQuery, 1, vehicles, gVehicleSceneQueryData->getRaycastQueryResultBufferSize(), gVehicleSceneQueryData->getRaycastQueryResultBuffer());
