...
#ifndef GU_DISTANCE_POINT_SEGMENT_SIMD_H
#define GU_DISTANCE_POINT_SEGMENT_SIMD_H
...
namespace Gu
{
	...
	PX_PHYSX_COMMON_API Ps::aos::FloatV distancePointSegmentSquared(const Ps::aos::Vec3VArg a, const Ps::aos::Vec3VArg b, 
																		const Ps::aos::Vec3VArg p, Ps::aos::FloatV& param);
