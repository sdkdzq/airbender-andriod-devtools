...
namespace Gu  
{
	...
	public:
		...
		bool isInflatedShape;
		EPASupportMapPair(bool _isInflatedShape = false): isInflatedShape(_isInflatedShape)
		{
		}
	...
	public:
		...
		EPASupportMapPairRelativeImpl(const ConvexA& _convA, const ConvexB& _convB, const Ps::aos::PsMatTransformV& _aToB, bool _isInflatedShape=false) : EPASupportMapPair(_isInflatedShape), convA(_convA), convB(_convB), aToB(_aToB)
		{
		}
	...
	public:
		...
		EPASupportMapPairLocalImpl(const ConvexA& _convA, const ConvexB& _convB, const bool _isInflatedShape = false) : EPASupportMapPair(_isInflatedShape), convA(_convA), convB(_convB)
		{
		}
