...
template<class T> PX_CUDA_CALLABLE PX_INLINE void checkType(const Gu::GeometryUnion& geometry);
...
//~PX_SERIALIZATION
	...
	PX_CUDA_CALLABLE PX_FORCE_INLINE const PxGeometry&		get()		const	{ return reinterpret_cast<const PxGeometry&>(geometry);				}
