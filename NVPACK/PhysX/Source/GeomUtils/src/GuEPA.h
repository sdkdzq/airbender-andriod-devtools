...
namespace Gu
{
	PxGJKStatus epaPenetration(const ConvexV& a, const ConvexV& b, EPASupportMapPair* pair, PxU8* PX_RESTRICT aInd, PxU8* PX_RESTRICT bInd, PxU8 _size, Ps::aos::Vec3V& contactA, Ps::aos::Vec3V& contactB, Ps::aos::Vec3V& normal, Ps::aos::FloatV& penetrationDepth);
...
//	private:
	...
	public:
		...
		PxGJKStatus PenetrationDepth(const ConvexV& a, const ConvexV& b, EPASupportMapPair* pair, const Ps::aos::Vec3V* PX_RESTRICT Q, const Ps::aos::Vec3V* PX_RESTRICT A, const Ps::aos::Vec3V* PX_RESTRICT B, const PxI32 size, Ps::aos::Vec3V& pa, Ps::aos::Vec3V& pb);
		bool expandSegment(const ConvexV& a, const ConvexV& b, EPASupportMapPair* pair);
