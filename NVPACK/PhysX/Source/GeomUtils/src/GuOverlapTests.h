...
//	PX_PHYSX_COMMON_API bool intersectSphereConvex	(const PxSphereGeometry& sphereGeom, const PxTransform& sphereGlobalPose, const Gu::ConvexMesh& mesh, const PxMeshScale& meshScale, const PxTransform& convexGlobalPose, PxVec3* cachedSepAxis);
	...
	PX_PHYSX_COMMON_API bool intersectSphereMeshAny	(const Gu::Sphere& worldSphere,		const Gu::RTreeMidphase& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling);
	PX_PHYSX_COMMON_API bool intersectCapsuleMeshAny(const Gu::Capsule& worldCapsule,	const Gu::RTreeMidphase& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling);
	PX_PHYSX_COMMON_API bool intersectBoxMeshAny	(const Gu::Box& worldOBB,			const Gu::RTreeMidphase& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling);
