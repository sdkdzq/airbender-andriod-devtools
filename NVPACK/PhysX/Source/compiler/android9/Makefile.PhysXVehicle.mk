...
PhysXVehicle_cpp_checked_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.checked.P, $(PhysXVehicle_cppfiles)))))
PhysXVehicle_c_checked_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.checked.P, $(PhysXVehicle_cfiles)))))
...
PhysXVehicle_cpp_profile_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.profile.P, $(PhysXVehicle_cppfiles)))))
PhysXVehicle_c_profile_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.profile.P, $(PhysXVehicle_cfiles)))))
...
PhysXVehicle_cpp_release_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.release.P, $(PhysXVehicle_cppfiles)))))
PhysXVehicle_c_release_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.release.P, $(PhysXVehicle_cfiles)))))
...
PhysXVehicle_checked_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
PhysXVehicle_checked_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
PhysXVehicle_checked_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
PhysXVehicle_checked_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
PhysXVehicle_checked_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
PhysXVehicle_checked_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
PhysXVehicle_checked_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
PhysXVehicle_checked_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
PhysXVehicle_checked_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
$(PhysXVehicle_checked_cpp_o): $(PhysXVehicle_checked_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_checked_objsdir),, $@))), $(PhysXVehicle_cppfiles))))))
	@cp $(PhysXVehicle_checked_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_checked_objsdir),, $@))), $(PhysXVehicle_cppfiles))))).checked.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(PhysXVehicle_checked_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_checked_objsdir),, $@))), $(PhysXVehicle_cppfiles))))).checked.P; \
...
$(PhysXVehicle_checked_c_o): $(PhysXVehicle_checked_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_checked_objsdir),, $@))), $(PhysXVehicle_cfiles))))))
	@cp $(PhysXVehicle_checked_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_checked_objsdir),, $@))), $(PhysXVehicle_cfiles))))).checked.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(PhysXVehicle_checked_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_checked_objsdir),, $@))), $(PhysXVehicle_cfiles))))).checked.P; \
	  rm -f $(PhysXVehicle_checked_DEPDIR).d
...
PhysXVehicle_profile_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
PhysXVehicle_profile_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
PhysXVehicle_profile_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
PhysXVehicle_profile_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
PhysXVehicle_profile_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
PhysXVehicle_profile_cflags  += -fno-omit-frame-pointer -marm -funswitch-loops -finline-limit=300
PhysXVehicle_profile_cppflags	:= $(PhysXVehicle_profile_common_cflags)
PhysXVehicle_profile_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
PhysXVehicle_profile_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
PhysXVehicle_profile_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
PhysXVehicle_profile_cppflags  += -fno-omit-frame-pointer -marm -funswitch-loops -finline-limit=300
...
PhysXVehicle_profile_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
$(PhysXVehicle_profile_cpp_o): $(PhysXVehicle_profile_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_profile_objsdir),, $@))), $(PhysXVehicle_cppfiles))))))
	@cp $(PhysXVehicle_profile_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_profile_objsdir),, $@))), $(PhysXVehicle_cppfiles))))).profile.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(PhysXVehicle_profile_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_profile_objsdir),, $@))), $(PhysXVehicle_cppfiles))))).profile.P; \
...
$(PhysXVehicle_profile_c_o): $(PhysXVehicle_profile_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_profile_objsdir),, $@))), $(PhysXVehicle_cfiles))))))
	@cp $(PhysXVehicle_profile_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_profile_objsdir),, $@))), $(PhysXVehicle_cfiles))))).profile.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(PhysXVehicle_profile_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_profile_objsdir),, $@))), $(PhysXVehicle_cfiles))))).profile.P; \
	  rm -f $(PhysXVehicle_profile_DEPDIR).d
...
PhysXVehicle_release_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
PhysXVehicle_release_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
PhysXVehicle_release_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
PhysXVehicle_release_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
PhysXVehicle_release_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
PhysXVehicle_release_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
PhysXVehicle_release_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
PhysXVehicle_release_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
PhysXVehicle_release_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
$(PhysXVehicle_release_cpp_o): $(PhysXVehicle_release_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_release_objsdir),, $@))), $(PhysXVehicle_cppfiles))))))
	@cp $(PhysXVehicle_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_release_objsdir),, $@))), $(PhysXVehicle_cppfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(PhysXVehicle_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(PhysXVehicle_release_objsdir),, $@))), $(PhysXVehicle_cppfiles))))).release.P; \
...
$(PhysXVehicle_release_c_o): $(PhysXVehicle_release_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_release_objsdir),, $@))), $(PhysXVehicle_cfiles))))))
	@cp $(PhysXVehicle_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_release_objsdir),, $@))), $(PhysXVehicle_cfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(PhysXVehicle_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(PhysXVehicle_release_objsdir),, $@))), $(PhysXVehicle_cfiles))))).release.P; \
	  rm -f $(PhysXVehicle_release_DEPDIR).d
...
clean_PhysXVehicle:  clean_PhysXVehicle_checked clean_PhysXVehicle_profile clean_PhysXVehicle_release
	@rm -rf $(DEPSDIR)
