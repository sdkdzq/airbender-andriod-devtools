...
static void getBinaryMetaData_PxFixedSizeLookupTable(PxOutputStream& stream)
{
	...
	public:
		...
		{
			PX_DEF_BIN_METADATA_CLASS(stream,		ShadowLookupTable)
			PX_DEF_BIN_METADATA_ITEMS_AUTO(stream,	PxVehicleEngineTable,	PxReal,	mDataPairs,		0)	
			PX_DEF_BIN_METADATA_ITEM(stream,		PxVehicleEngineTable,	PxU32,	mNbDataPairs,	0)	
			PX_DEF_BIN_METADATA_ITEMS_AUTO(stream,	PxVehicleEngineTable,	PxU32,	mPad,			PxMetaDataFlag::ePADDING)
		}
	};
