...
PX_PROFILE_EVENT(SimTask, ScIslandGen, PX_PROFILE_TASK_PRIORITY)
PX_PROFILE_EVENT(SimTask, ScPostIslandGen, PX_PROFILE_TASK_PRIORITY)
...
PX_PROFILE_EVENT(SimAPI, shiftOrigin, Medium)
...
PX_PROFILE_EVENT(Sim, createFinalize, Detail)
PX_PROFILE_EVENT(Sim, setupFinalize, Detail)
PX_PROFILE_EVENT(Sim, getFrictionPatch, Detail)
PX_PROFILE_EVENT(Sim, createContactPatches, Detail)
PX_PROFILE_EVENT(Sim, correlatePatches, Detail)
PX_PROFILE_EVENT(Sim, growPatches, Detail)
...
PX_PROFILE_EVENT(Sim, syncBodiesAfterSolver, Coarse)
PX_PROFILE_EVENT(Sim, syncBodiesAfterIntegration, Coarse)
...
#define PX_PROFILE_BASIC_PRIORITY Medium
...
PX_PROFILE_EVENT(Articulations, prepareDataBlock, PX_PROFILE_ARTICULATION_PRIORITY)
...
PX_PROFILE_EVENT(IslandGen, emptyIslands, PX_PROFILE_ISLANDGEN_PRIORITY)
PX_PROFILE_EVENT(IslandGen, joinedEdges, PX_PROFILE_ISLANDGEN_PRIORITY)
PX_PROFILE_EVENT(IslandGen, createdNodes, PX_PROFILE_ISLANDGEN_PRIORITY)
PX_PROFILE_EVENT(IslandGen, duplicateKinematicNodes, PX_PROFILE_ISLANDGEN_PRIORITY)
PX_PROFILE_EVENT(IslandGen, brokenEdgeIslands, PX_PROFILE_ISLANDGEN_PRIORITY)
PX_PROFILE_EVENT(IslandGen, processSleepingIslands, PX_PROFILE_ISLANDGEN_PRIORITY)
PX_PROFILE_EVENT(IslandGen, mergeKinematicNodeIslands, PX_PROFILE_ISLANDGEN_PRIORITY)
PX_PROFILE_EVENT(IslandGen, deletedNodesEdges, PX_PROFILE_ISLANDGEN_PRIORITY)
...
PX_PROFILE_EVENT(PVD, ORIGIN_SHFIT, Medium)
