...
#ifndef PX_WIIU	// Whenever a variable points to a field of a specially aligned struct, it has to be declared with __packed (see GHS docu, Structure Packing, page 111).
...
#pragma pack(pop)
	...
	public:
		...
		PxControllerCollisionFlags		moveCharacter(
