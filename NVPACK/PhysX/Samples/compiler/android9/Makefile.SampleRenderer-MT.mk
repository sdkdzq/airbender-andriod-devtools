...
SampleRenderer-MT_cpp_debug_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.debug.P, $(SampleRenderer-MT_cppfiles)))))
SampleRenderer-MT_c_debug_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.debug.P, $(SampleRenderer-MT_cfiles)))))
...
SampleRenderer-MT_cpp_release_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.release.P, $(SampleRenderer-MT_cppfiles)))))
SampleRenderer-MT_c_release_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.release.P, $(SampleRenderer-MT_cfiles)))))
...
SampleRenderer-MT_cpp_checked_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.checked.P, $(SampleRenderer-MT_cppfiles)))))
SampleRenderer-MT_c_checked_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.checked.P, $(SampleRenderer-MT_cfiles)))))
...
SampleRenderer-MT_cpp_profile_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.profile.P, $(SampleRenderer-MT_cppfiles)))))
SampleRenderer-MT_c_profile_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.profile.P, $(SampleRenderer-MT_cfiles)))))
...
SampleRenderer-MT_debug_hpaths    += ./../../../Source/shared/general/PxIOStream/include
SampleRenderer-MT_debug_hpaths    += ./../../../Source/shared/general/PxIOStream/public
SampleRenderer-MT_debug_hpaths    += ./../../../Source/shared/general/shared
...
SampleRenderer-MT_debug_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
SampleRenderer-MT_debug_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
SampleRenderer-MT_debug_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleRenderer-MT_debug_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleRenderer-MT_debug_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleRenderer-MT_debug_cflags  += -g3 -gdwarf-2
SampleRenderer-MT_debug_cppflags	:= $(SampleRenderer-MT_debug_common_cflags)
SampleRenderer-MT_debug_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleRenderer-MT_debug_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleRenderer-MT_debug_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleRenderer-MT_debug_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleRenderer-MT_debug_bin      := ./../../SampleFramework/renderer/lib/android9/libSampleRenderer-MTDEBUG.a
...
$(SampleRenderer-MT_debug_bin): $(SampleRenderer-MT_debug_obj) 
	@mkdir -p `dirname ./../../SampleFramework/renderer/lib/android9/libSampleRenderer-MTDEBUG.a`
...
$(SampleRenderer-MT_debug_cpp_o): $(SampleRenderer-MT_debug_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_debug_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))))
	@cp $(SampleRenderer-MT_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_debug_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleRenderer-MT_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_debug_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))).debug.P; \
...
$(SampleRenderer-MT_debug_c_o): $(SampleRenderer-MT_debug_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_debug_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))))
	@cp $(SampleRenderer-MT_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_debug_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleRenderer-MT_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_debug_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))).debug.P; \
	  rm -f $(SampleRenderer-MT_debug_DEPDIR).d

$(SampleRenderer-MT_debug_cc_o): $(SampleRenderer-MT_debug_objsdir)/%.o:
	@$(ECHO) SampleRenderer-MT: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SampleRenderer-MT_debug_objsdir),, $@))), $(SampleRenderer-MT_ccfiles))...
	@mkdir -p $(dir $(@))
...
SampleRenderer-MT_release_hpaths    += ./../../../Source/shared/general/PxIOStream/include
SampleRenderer-MT_release_hpaths    += ./../../../Source/shared/general/PxIOStream/public
SampleRenderer-MT_release_hpaths    += ./../../../Source/shared/general/shared
...
SampleRenderer-MT_release_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
SampleRenderer-MT_release_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
SampleRenderer-MT_release_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleRenderer-MT_release_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleRenderer-MT_release_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleRenderer-MT_release_cflags  += -O3 -fno-strict-aliasing
SampleRenderer-MT_release_cflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleRenderer-MT_release_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
SampleRenderer-MT_release_cppflags	:= $(SampleRenderer-MT_release_common_cflags)
SampleRenderer-MT_release_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleRenderer-MT_release_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleRenderer-MT_release_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleRenderer-MT_release_cppflags  += -O3 -fno-strict-aliasing
SampleRenderer-MT_release_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleRenderer-MT_release_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
SampleRenderer-MT_release_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleRenderer-MT_release_bin      := ./../../SampleFramework/renderer/lib/android9/libSampleRenderer-MT.a
...
$(SampleRenderer-MT_release_bin): $(SampleRenderer-MT_release_obj) 
	@mkdir -p `dirname ./../../SampleFramework/renderer/lib/android9/libSampleRenderer-MT.a`
...
$(SampleRenderer-MT_release_cpp_o): $(SampleRenderer-MT_release_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_release_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))))
	@cp $(SampleRenderer-MT_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_release_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleRenderer-MT_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_release_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))).release.P; \
...
$(SampleRenderer-MT_release_c_o): $(SampleRenderer-MT_release_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_release_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))))
	@cp $(SampleRenderer-MT_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_release_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleRenderer-MT_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_release_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))).release.P; \
	  rm -f $(SampleRenderer-MT_release_DEPDIR).d

$(SampleRenderer-MT_release_cc_o): $(SampleRenderer-MT_release_objsdir)/%.o:
	@$(ECHO) SampleRenderer-MT: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SampleRenderer-MT_release_objsdir),, $@))), $(SampleRenderer-MT_ccfiles))...
	@mkdir -p $(dir $(@))
...
SampleRenderer-MT_checked_hpaths    += ./../../../Source/shared/general/PxIOStream/include
SampleRenderer-MT_checked_hpaths    += ./../../../Source/shared/general/PxIOStream/public
SampleRenderer-MT_checked_hpaths    += ./../../../Source/shared/general/shared
...
SampleRenderer-MT_checked_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
SampleRenderer-MT_checked_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
SampleRenderer-MT_checked_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleRenderer-MT_checked_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleRenderer-MT_checked_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleRenderer-MT_checked_cflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
SampleRenderer-MT_checked_cflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleRenderer-MT_checked_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
SampleRenderer-MT_checked_cppflags	:= $(SampleRenderer-MT_checked_common_cflags)
SampleRenderer-MT_checked_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleRenderer-MT_checked_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleRenderer-MT_checked_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleRenderer-MT_checked_cppflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
SampleRenderer-MT_checked_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleRenderer-MT_checked_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
SampleRenderer-MT_checked_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleRenderer-MT_checked_bin      := ./../../SampleFramework/renderer/lib/android9/libSampleRenderer-MTCHECKED.a
...
$(SampleRenderer-MT_checked_bin): $(SampleRenderer-MT_checked_obj) 
	@mkdir -p `dirname ./../../SampleFramework/renderer/lib/android9/libSampleRenderer-MTCHECKED.a`
...
$(SampleRenderer-MT_checked_cpp_o): $(SampleRenderer-MT_checked_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_checked_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))))
	@cp $(SampleRenderer-MT_checked_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_checked_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))).checked.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleRenderer-MT_checked_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_checked_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))).checked.P; \
...
$(SampleRenderer-MT_checked_c_o): $(SampleRenderer-MT_checked_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_checked_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))))
	@cp $(SampleRenderer-MT_checked_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_checked_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))).checked.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleRenderer-MT_checked_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_checked_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))).checked.P; \
	  rm -f $(SampleRenderer-MT_checked_DEPDIR).d

$(SampleRenderer-MT_checked_cc_o): $(SampleRenderer-MT_checked_objsdir)/%.o:
	@$(ECHO) SampleRenderer-MT: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SampleRenderer-MT_checked_objsdir),, $@))), $(SampleRenderer-MT_ccfiles))...
	@mkdir -p $(dir $(@))
...
SampleRenderer-MT_profile_hpaths    += ./../../../Source/shared/general/PxIOStream/include
SampleRenderer-MT_profile_hpaths    += ./../../../Source/shared/general/PxIOStream/public
SampleRenderer-MT_profile_hpaths    += ./../../../Source/shared/general/shared
...
SampleRenderer-MT_profile_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
SampleRenderer-MT_profile_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
SampleRenderer-MT_profile_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleRenderer-MT_profile_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleRenderer-MT_profile_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleRenderer-MT_profile_cflags  += -O3 -fno-strict-aliasing
SampleRenderer-MT_profile_cflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleRenderer-MT_profile_cflags  += -fno-omit-frame-pointer -marm -funswitch-loops -finline-limit=300
SampleRenderer-MT_profile_cppflags	:= $(SampleRenderer-MT_profile_common_cflags)
SampleRenderer-MT_profile_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleRenderer-MT_profile_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleRenderer-MT_profile_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleRenderer-MT_profile_cppflags  += -O3 -fno-strict-aliasing
SampleRenderer-MT_profile_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleRenderer-MT_profile_cppflags  += -fno-omit-frame-pointer -marm -funswitch-loops -finline-limit=300
...
SampleRenderer-MT_profile_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleRenderer-MT_profile_bin      := ./../../SampleFramework/renderer/lib/android9/libSampleRenderer-MTPROFILE.a
...
$(SampleRenderer-MT_profile_bin): $(SampleRenderer-MT_profile_obj) 
	@mkdir -p `dirname ./../../SampleFramework/renderer/lib/android9/libSampleRenderer-MTPROFILE.a`
...
$(SampleRenderer-MT_profile_cpp_o): $(SampleRenderer-MT_profile_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_profile_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))))
	@cp $(SampleRenderer-MT_profile_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_profile_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))).profile.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleRenderer-MT_profile_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleRenderer-MT_profile_objsdir),, $@))), $(SampleRenderer-MT_cppfiles))))).profile.P; \
...
$(SampleRenderer-MT_profile_c_o): $(SampleRenderer-MT_profile_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_profile_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))))
	@cp $(SampleRenderer-MT_profile_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_profile_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))).profile.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleRenderer-MT_profile_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleRenderer-MT_profile_objsdir),, $@))), $(SampleRenderer-MT_cfiles))))).profile.P; \
	  rm -f $(SampleRenderer-MT_profile_DEPDIR).d

$(SampleRenderer-MT_profile_cc_o): $(SampleRenderer-MT_profile_objsdir)/%.o:
	@$(ECHO) SampleRenderer-MT: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SampleRenderer-MT_profile_objsdir),, $@))), $(SampleRenderer-MT_ccfiles))...
	@mkdir -p $(dir $(@))
