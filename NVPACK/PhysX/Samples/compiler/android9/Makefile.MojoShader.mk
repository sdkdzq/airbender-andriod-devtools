...
MojoShader_cpp_debug_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.debug.P, $(MojoShader_cppfiles)))))
MojoShader_c_debug_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.debug.P, $(MojoShader_cfiles)))))
...
MojoShader_cpp_release_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.release.P, $(MojoShader_cppfiles)))))
MojoShader_c_release_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.release.P, $(MojoShader_cfiles)))))
...
MojoShader_cpp_checked_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.checked.P, $(MojoShader_cppfiles)))))
MojoShader_c_checked_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.checked.P, $(MojoShader_cfiles)))))
...
MojoShader_cpp_profile_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.profile.P, $(MojoShader_cppfiles)))))
MojoShader_c_profile_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.profile.P, $(MojoShader_cfiles)))))
...
MojoShader_debug_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions
MojoShader_debug_cflags  += -Wno-unknown-pragmas -Wno-psabi
MojoShader_debug_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
MojoShader_debug_cflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/include
MojoShader_debug_cflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/include
MojoShader_debug_cflags  += -g3 -gdwarf-2
MojoShader_debug_cppflags	:= $(MojoShader_debug_common_cflags)
MojoShader_debug_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions
MojoShader_debug_cppflags  += -Wno-unknown-pragmas -Wno-psabi
MojoShader_debug_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
MojoShader_debug_cppflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/include
MojoShader_debug_cppflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/include
MojoShader_debug_cppflags  += -g3 -gdwarf-2
...
MojoShader_debug_bin      := ./../../../externals/mojoshader/1067/lib/android9/libMojoShaderDEBUG.a
...
$(MojoShader_debug_bin): $(MojoShader_debug_obj) 
	@mkdir -p `dirname ./../../../externals/mojoshader/1067/lib/android9/libMojoShaderDEBUG.a`
...
$(MojoShader_debug_cpp_o): $(MojoShader_debug_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_debug_objsdir),, $@))), $(MojoShader_cppfiles))))))
	@cp $(MojoShader_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_debug_objsdir),, $@))), $(MojoShader_cppfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(MojoShader_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_debug_objsdir),, $@))), $(MojoShader_cppfiles))))).debug.P; \
...
$(MojoShader_debug_c_o): $(MojoShader_debug_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_debug_objsdir),, $@))), $(MojoShader_cfiles))))))
	@cp $(MojoShader_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_debug_objsdir),, $@))), $(MojoShader_cfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(MojoShader_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_debug_objsdir),, $@))), $(MojoShader_cfiles))))).debug.P; \
	  rm -f $(MojoShader_debug_DEPDIR).d

$(MojoShader_debug_cc_o): $(MojoShader_debug_objsdir)/%.o:
	@$(ECHO) MojoShader: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(MojoShader_debug_objsdir),, $@))), $(MojoShader_ccfiles))...
	@mkdir -p $(dir $(@))
...
MojoShader_release_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions
MojoShader_release_cflags  += -Wno-unknown-pragmas -Wno-psabi
MojoShader_release_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
MojoShader_release_cflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/include
MojoShader_release_cflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/include
MojoShader_release_cflags  += -O3 -fno-strict-aliasing
MojoShader_release_cflags  += -ffunction-sections -funwind-tables -fstack-protector
MojoShader_release_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
MojoShader_release_cppflags	:= $(MojoShader_release_common_cflags)
MojoShader_release_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions
MojoShader_release_cppflags  += -Wno-unknown-pragmas -Wno-psabi
MojoShader_release_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
MojoShader_release_cppflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/include
MojoShader_release_cppflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/include
MojoShader_release_cppflags  += -O3 -fno-strict-aliasing
MojoShader_release_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
MojoShader_release_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
MojoShader_release_bin      := ./../../../externals/mojoshader/1067/lib/android9/libMojoShader.a
...
$(MojoShader_release_bin): $(MojoShader_release_obj) 
	@mkdir -p `dirname ./../../../externals/mojoshader/1067/lib/android9/libMojoShader.a`
...
$(MojoShader_release_cpp_o): $(MojoShader_release_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_release_objsdir),, $@))), $(MojoShader_cppfiles))))))
	@cp $(MojoShader_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_release_objsdir),, $@))), $(MojoShader_cppfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(MojoShader_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_release_objsdir),, $@))), $(MojoShader_cppfiles))))).release.P; \
...
$(MojoShader_release_c_o): $(MojoShader_release_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_release_objsdir),, $@))), $(MojoShader_cfiles))))))
	@cp $(MojoShader_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_release_objsdir),, $@))), $(MojoShader_cfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(MojoShader_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_release_objsdir),, $@))), $(MojoShader_cfiles))))).release.P; \
	  rm -f $(MojoShader_release_DEPDIR).d

$(MojoShader_release_cc_o): $(MojoShader_release_objsdir)/%.o:
	@$(ECHO) MojoShader: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(MojoShader_release_objsdir),, $@))), $(MojoShader_ccfiles))...
	@mkdir -p $(dir $(@))
...
MojoShader_checked_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions
MojoShader_checked_cflags  += -Wno-unknown-pragmas -Wno-psabi
MojoShader_checked_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
MojoShader_checked_cflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/include
MojoShader_checked_cflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/include
MojoShader_checked_cflags  += -O3 -fno-strict-aliasing
MojoShader_checked_cflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
MojoShader_checked_cflags  += -ffunction-sections -funwind-tables -fstack-protector
MojoShader_checked_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
MojoShader_checked_cppflags	:= $(MojoShader_checked_common_cflags)
MojoShader_checked_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions
MojoShader_checked_cppflags  += -Wno-unknown-pragmas -Wno-psabi
MojoShader_checked_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
MojoShader_checked_cppflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/include
MojoShader_checked_cppflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/include
MojoShader_checked_cppflags  += -O3 -fno-strict-aliasing
MojoShader_checked_cppflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
MojoShader_checked_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
MojoShader_checked_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
MojoShader_checked_bin      := ./../../../externals/mojoshader/1067/lib/android9/libMojoShaderCHECKED.a
...
$(MojoShader_checked_bin): $(MojoShader_checked_obj) 
	@mkdir -p `dirname ./../../../externals/mojoshader/1067/lib/android9/libMojoShaderCHECKED.a`
...
$(MojoShader_checked_cpp_o): $(MojoShader_checked_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_checked_objsdir),, $@))), $(MojoShader_cppfiles))))))
	@cp $(MojoShader_checked_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_checked_objsdir),, $@))), $(MojoShader_cppfiles))))).checked.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(MojoShader_checked_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_checked_objsdir),, $@))), $(MojoShader_cppfiles))))).checked.P; \
...
$(MojoShader_checked_c_o): $(MojoShader_checked_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_checked_objsdir),, $@))), $(MojoShader_cfiles))))))
	@cp $(MojoShader_checked_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_checked_objsdir),, $@))), $(MojoShader_cfiles))))).checked.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(MojoShader_checked_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_checked_objsdir),, $@))), $(MojoShader_cfiles))))).checked.P; \
	  rm -f $(MojoShader_checked_DEPDIR).d

$(MojoShader_checked_cc_o): $(MojoShader_checked_objsdir)/%.o:
	@$(ECHO) MojoShader: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(MojoShader_checked_objsdir),, $@))), $(MojoShader_ccfiles))...
	@mkdir -p $(dir $(@))
...
MojoShader_profile_cflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions
MojoShader_profile_cflags  += -Wno-unknown-pragmas -Wno-psabi
MojoShader_profile_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
MojoShader_profile_cflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/include
MojoShader_profile_cflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/include
MojoShader_profile_cflags  += -O3 -fno-strict-aliasing
MojoShader_profile_cflags  += -ffunction-sections -funwind-tables -fstack-protector
MojoShader_profile_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
MojoShader_profile_cppflags	:= $(MojoShader_profile_common_cflags)
MojoShader_profile_cppflags  += -fpic -march=armv7-a -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb-interwork -fno-exceptions
MojoShader_profile_cppflags  += -Wno-unknown-pragmas -Wno-psabi
MojoShader_profile_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
MojoShader_profile_cppflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/include
MojoShader_profile_cppflags  += -I../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/libs/armeabi-v7a/include
MojoShader_profile_cppflags  += -O3 -fno-strict-aliasing
MojoShader_profile_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
MojoShader_profile_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
MojoShader_profile_bin      := ./../../../externals/mojoshader/1067/lib/android9/libMojoShaderPROFILE.a
...
$(MojoShader_profile_bin): $(MojoShader_profile_obj) 
	@mkdir -p `dirname ./../../../externals/mojoshader/1067/lib/android9/libMojoShaderPROFILE.a`
...
$(MojoShader_profile_cpp_o): $(MojoShader_profile_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_profile_objsdir),, $@))), $(MojoShader_cppfiles))))))
	@cp $(MojoShader_profile_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_profile_objsdir),, $@))), $(MojoShader_cppfiles))))).profile.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(MojoShader_profile_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(MojoShader_profile_objsdir),, $@))), $(MojoShader_cppfiles))))).profile.P; \
...
$(MojoShader_profile_c_o): $(MojoShader_profile_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_profile_objsdir),, $@))), $(MojoShader_cfiles))))))
	@cp $(MojoShader_profile_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_profile_objsdir),, $@))), $(MojoShader_cfiles))))).profile.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(MojoShader_profile_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(MojoShader_profile_objsdir),, $@))), $(MojoShader_cfiles))))).profile.P; \
	  rm -f $(MojoShader_profile_DEPDIR).d

$(MojoShader_profile_cc_o): $(MojoShader_profile_objsdir)/%.o:
	@$(ECHO) MojoShader: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(MojoShader_profile_objsdir),, $@))), $(MojoShader_ccfiles))...
	@mkdir -p $(dir $(@))
