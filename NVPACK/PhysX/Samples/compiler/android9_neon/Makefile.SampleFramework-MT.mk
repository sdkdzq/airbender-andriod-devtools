...
SampleFramework-MT_cpp_debug_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.debug.P, $(SampleFramework-MT_cppfiles)))))
SampleFramework-MT_c_debug_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.debug.P, $(SampleFramework-MT_cfiles)))))
...
SampleFramework-MT_cpp_release_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.release.P, $(SampleFramework-MT_cppfiles)))))
SampleFramework-MT_c_release_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.release.P, $(SampleFramework-MT_cfiles)))))
...
SampleFramework-MT_cpp_checked_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.checked.P, $(SampleFramework-MT_cppfiles)))))
SampleFramework-MT_c_checked_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.checked.P, $(SampleFramework-MT_cfiles)))))
...
SampleFramework-MT_cpp_profile_dep    = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.cpp, %.cpp.profile.P, $(SampleFramework-MT_cppfiles)))))
SampleFramework-MT_c_profile_dep      = $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(patsubst %.c, %.c.profile.P, $(SampleFramework-MT_cfiles)))))
...
SampleFramework-MT_debug_hpaths    += ./../../../Source/shared/general/PxIOStream/include
SampleFramework-MT_debug_hpaths    += ./../../../Source/shared/general/PxIOStream/public
SampleFramework-MT_debug_hpaths    += ./../../../Source/shared/general/string_parsing/include
SampleFramework-MT_debug_hpaths    += ./../../../Source/shared/general/shared
...
SampleFramework-MT_debug_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
SampleFramework-MT_debug_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
SampleFramework-MT_debug_cflags  += -fpic -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleFramework-MT_debug_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleFramework-MT_debug_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleFramework-MT_debug_cflags  += -g3 -gdwarf-2
SampleFramework-MT_debug_cppflags	:= $(SampleFramework-MT_debug_common_cflags)
SampleFramework-MT_debug_cppflags  += -fpic -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleFramework-MT_debug_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleFramework-MT_debug_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleFramework-MT_debug_cppflags  += -g3 -gdwarf-2
...
SampleFramework-MT_debug_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleFramework-MT_debug_bin      := ./../../SampleFramework/framework/lib/android9_neon/libSampleFramework-MTDEBUG.a
...
$(SampleFramework-MT_debug_bin): $(SampleFramework-MT_debug_obj) 
	@mkdir -p `dirname ./../../SampleFramework/framework/lib/android9_neon/libSampleFramework-MTDEBUG.a`
...
$(SampleFramework-MT_debug_cpp_o): $(SampleFramework-MT_debug_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_debug_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))))
	@cp $(SampleFramework-MT_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_debug_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleFramework-MT_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_debug_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))).debug.P; \
...
$(SampleFramework-MT_debug_c_o): $(SampleFramework-MT_debug_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_debug_objsdir),, $@))), $(SampleFramework-MT_cfiles))))))
	@cp $(SampleFramework-MT_debug_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_debug_objsdir),, $@))), $(SampleFramework-MT_cfiles))))).debug.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleFramework-MT_debug_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_debug_objsdir),, $@))), $(SampleFramework-MT_cfiles))))).debug.P; \
	  rm -f $(SampleFramework-MT_debug_DEPDIR).d

$(SampleFramework-MT_debug_cc_o): $(SampleFramework-MT_debug_objsdir)/%.o:
	@$(ECHO) SampleFramework-MT: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SampleFramework-MT_debug_objsdir),, $@))), $(SampleFramework-MT_ccfiles))...
	@mkdir -p $(dir $(@))
...
SampleFramework-MT_release_hpaths    += ./../../../Source/shared/general/PxIOStream/include
SampleFramework-MT_release_hpaths    += ./../../../Source/shared/general/PxIOStream/public
SampleFramework-MT_release_hpaths    += ./../../../Source/shared/general/string_parsing/include
SampleFramework-MT_release_hpaths    += ./../../../Source/shared/general/shared
...
SampleFramework-MT_release_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
SampleFramework-MT_release_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
SampleFramework-MT_release_cflags  += -fpic -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleFramework-MT_release_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleFramework-MT_release_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleFramework-MT_release_cflags  += -O3 -fno-strict-aliasing
SampleFramework-MT_release_cflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleFramework-MT_release_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
SampleFramework-MT_release_cppflags	:= $(SampleFramework-MT_release_common_cflags)
SampleFramework-MT_release_cppflags  += -fpic -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleFramework-MT_release_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleFramework-MT_release_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleFramework-MT_release_cppflags  += -O3 -fno-strict-aliasing
SampleFramework-MT_release_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleFramework-MT_release_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
SampleFramework-MT_release_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleFramework-MT_release_bin      := ./../../SampleFramework/framework/lib/android9_neon/libSampleFramework-MT.a
...
$(SampleFramework-MT_release_bin): $(SampleFramework-MT_release_obj) 
	@mkdir -p `dirname ./../../SampleFramework/framework/lib/android9_neon/libSampleFramework-MT.a`
...
$(SampleFramework-MT_release_cpp_o): $(SampleFramework-MT_release_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_release_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))))
	@cp $(SampleFramework-MT_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_release_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleFramework-MT_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_release_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))).release.P; \
...
$(SampleFramework-MT_release_c_o): $(SampleFramework-MT_release_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_release_objsdir),, $@))), $(SampleFramework-MT_cfiles))))))
	@cp $(SampleFramework-MT_release_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_release_objsdir),, $@))), $(SampleFramework-MT_cfiles))))).release.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleFramework-MT_release_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_release_objsdir),, $@))), $(SampleFramework-MT_cfiles))))).release.P; \
	  rm -f $(SampleFramework-MT_release_DEPDIR).d

$(SampleFramework-MT_release_cc_o): $(SampleFramework-MT_release_objsdir)/%.o:
	@$(ECHO) SampleFramework-MT: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SampleFramework-MT_release_objsdir),, $@))), $(SampleFramework-MT_ccfiles))...
	@mkdir -p $(dir $(@))
...
SampleFramework-MT_checked_hpaths    += ./../../../Source/shared/general/PxIOStream/include
SampleFramework-MT_checked_hpaths    += ./../../../Source/shared/general/PxIOStream/public
SampleFramework-MT_checked_hpaths    += ./../../../Source/shared/general/string_parsing/include
SampleFramework-MT_checked_hpaths    += ./../../../Source/shared/general/shared
...
SampleFramework-MT_checked_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
SampleFramework-MT_checked_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
SampleFramework-MT_checked_cflags  += -fpic -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleFramework-MT_checked_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleFramework-MT_checked_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleFramework-MT_checked_cflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
SampleFramework-MT_checked_cflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleFramework-MT_checked_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
SampleFramework-MT_checked_cppflags	:= $(SampleFramework-MT_checked_common_cflags)
SampleFramework-MT_checked_cppflags  += -fpic -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleFramework-MT_checked_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleFramework-MT_checked_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleFramework-MT_checked_cppflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
SampleFramework-MT_checked_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleFramework-MT_checked_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
SampleFramework-MT_checked_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleFramework-MT_checked_bin      := ./../../SampleFramework/framework/lib/android9_neon/libSampleFramework-MTCHECKED.a
...
$(SampleFramework-MT_checked_bin): $(SampleFramework-MT_checked_obj) 
	@mkdir -p `dirname ./../../SampleFramework/framework/lib/android9_neon/libSampleFramework-MTCHECKED.a`
...
$(SampleFramework-MT_checked_cpp_o): $(SampleFramework-MT_checked_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_checked_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))))
	@cp $(SampleFramework-MT_checked_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_checked_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))).checked.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleFramework-MT_checked_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_checked_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))).checked.P; \
...
$(SampleFramework-MT_checked_c_o): $(SampleFramework-MT_checked_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_checked_objsdir),, $@))), $(SampleFramework-MT_cfiles))))))
	@cp $(SampleFramework-MT_checked_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_checked_objsdir),, $@))), $(SampleFramework-MT_cfiles))))).checked.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleFramework-MT_checked_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_checked_objsdir),, $@))), $(SampleFramework-MT_cfiles))))).checked.P; \
	  rm -f $(SampleFramework-MT_checked_DEPDIR).d

$(SampleFramework-MT_checked_cc_o): $(SampleFramework-MT_checked_objsdir)/%.o:
	@$(ECHO) SampleFramework-MT: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SampleFramework-MT_checked_objsdir),, $@))), $(SampleFramework-MT_ccfiles))...
	@mkdir -p $(dir $(@))
...
SampleFramework-MT_profile_hpaths    += ./../../../Source/shared/general/PxIOStream/include
SampleFramework-MT_profile_hpaths    += ./../../../Source/shared/general/PxIOStream/public
SampleFramework-MT_profile_hpaths    += ./../../../Source/shared/general/string_parsing/include
SampleFramework-MT_profile_hpaths    += ./../../../Source/shared/general/shared
...
SampleFramework-MT_profile_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/include
SampleFramework-MT_profile_hpaths    += ./../../../externals/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi-v7a/include
...
SampleFramework-MT_profile_cflags  += -fpic -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleFramework-MT_profile_cflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleFramework-MT_profile_cflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleFramework-MT_profile_cflags  += -O3 -fno-strict-aliasing
SampleFramework-MT_profile_cflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleFramework-MT_profile_cflags  += -fno-omit-frame-pointer -marm -funswitch-loops -finline-limit=300
SampleFramework-MT_profile_cppflags	:= $(SampleFramework-MT_profile_common_cflags)
SampleFramework-MT_profile_cppflags  += -fpic -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -fno-exceptions -fno-rtti
SampleFramework-MT_profile_cppflags  += -Wno-invalid-offsetof -Wno-unknown-pragmas -Wno-psabi
SampleFramework-MT_profile_cppflags  += -isysroot ../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
SampleFramework-MT_profile_cppflags  += -O3 -fno-strict-aliasing
SampleFramework-MT_profile_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
SampleFramework-MT_profile_cppflags  += -fno-omit-frame-pointer -marm -funswitch-loops -finline-limit=300
...
SampleFramework-MT_profile_lflags  += --sysroot=../../../externals/android-ndk-r8e/platforms/android-9/arch-arm
...
SampleFramework-MT_profile_bin      := ./../../SampleFramework/framework/lib/android9_neon/libSampleFramework-MTPROFILE.a
...
$(SampleFramework-MT_profile_bin): $(SampleFramework-MT_profile_obj) 
	@mkdir -p `dirname ./../../SampleFramework/framework/lib/android9_neon/libSampleFramework-MTPROFILE.a`
...
$(SampleFramework-MT_profile_cpp_o): $(SampleFramework-MT_profile_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_profile_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))))
	@cp $(SampleFramework-MT_profile_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_profile_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))).profile.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleFramework-MT_profile_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .cpp.o,.cpp, $(subst $(SampleFramework-MT_profile_objsdir),, $@))), $(SampleFramework-MT_cppfiles))))).profile.P; \
...
$(SampleFramework-MT_profile_c_o): $(SampleFramework-MT_profile_objsdir)/%.o:
	...
	@mkdir -p $(dir $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_profile_objsdir),, $@))), $(SampleFramework-MT_cfiles))))))
	@cp $(SampleFramework-MT_profile_DEPDIR).d $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_profile_objsdir),, $@))), $(SampleFramework-MT_cfiles))))).profile.P; \
	  sed -e 's/#.*//' -e 's/^[^:]*: *//' -e 's/ *\\$$//' \
		-e '/^$$/ d' -e 's/$$/ :/' < $(SampleFramework-MT_profile_DEPDIR).d >> $(addprefix $(DEPSDIR)/, $(subst ./, , $(subst ../, , $(filter %$(strip $(subst .c.o,.c, $(subst $(SampleFramework-MT_profile_objsdir),, $@))), $(SampleFramework-MT_cfiles))))).profile.P; \
	  rm -f $(SampleFramework-MT_profile_DEPDIR).d

$(SampleFramework-MT_profile_cc_o): $(SampleFramework-MT_profile_objsdir)/%.o:
	@$(ECHO) SampleFramework-MT: compiling  $(filter %$(strip $(subst .cc.o,.cc, $(subst $(SampleFramework-MT_profile_objsdir),, $@))), $(SampleFramework-MT_ccfiles))...
	@mkdir -p $(dir $(@))
