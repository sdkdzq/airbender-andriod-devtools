...
//		PxVec3 localCenter;
		const PxReal internalRadius = computeInternalRadius(actor, shape, dir, /*localCenter,*/ ccdWitnessOffset);
...
const PxVec3 testShapeCenter = getShapeCenter(actor, shape, ccdWitnessOffset);
