...
if not defined NDK_VERSION (set NDK_VERSION=android-ndk-r8e)
if not defined NDK_ROOT (set NDK_VERSION=%EXTERNALS%\externals\android-ndk)
...
set EXE="%EXTERNALS%\externals\clang\3.3.1\win32\bin\clang.exe"
