...
CUBLASAPI cublasStatus_t CUBLASWINAPI cublasSpotrf(
...
CUBLASAPI cublasStatus_t CUBLASWINAPI cublasDpotrf(
    cublasHandle_t handle,
    cublasFillMode_t uplo,
    int n,
    double *A,
...
CUBLASAPI cublasStatus_t CUBLASWINAPI cublasCpotrf(
    cublasHandle_t handle,
    cublasFillMode_t uplo,
    int n,
    cuComplex *A,
...
CUBLASAPI cublasStatus_t CUBLASWINAPI cublasZpotrf(
    cublasHandle_t handle,
    cublasFillMode_t uplo,
    int n,
    cuDoubleComplex *A,
