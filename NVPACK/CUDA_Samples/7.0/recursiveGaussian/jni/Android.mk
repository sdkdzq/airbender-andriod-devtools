...
include $(CLEAR_VARS)
LOCAL_MODULE := lib_recursiveGaussian
LOCAL_SRC_FILES := ../cuda/lib_recursiveGaussian.a
...
include $(CLEAR_VARS)
LOCAL_MODULE := recursiveGaussian
...
LOCAL_STATIC_LIBRARIES := lib_recursiveGaussian libcudart_static
